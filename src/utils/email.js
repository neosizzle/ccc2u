...
const sendEmail = (mailOptions ,{enquiryType,username,email,subject,message}, callback)=>{
    
    //creating nodemailer transport payload
    //the email here should be the transporters email.
    var smtpConfig = {
        host: 'smtp.gmail.com',
        port: 465,
        //secure: true, // use SSL
        auth: {
            user: process.env.REACT_APP_NODEMAILER_TRANS_EMAIL,
            pass: process.env.REACT_APP_NODEMAILER_TRANS_PASS
        }
    };
    var transporter = nodemailer.createTransport(smtpConfig);

    //declare message body (VERY LONG HTML)
    const emailBody = `
    ...
    <h1 style="color:#555555;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:23px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;"><u><strong> Customer enquiry email received</strong></u></h1>
    </td>
    </tr>
    </table>
    <!--[if (!mso)&(!IE)]><!-->
    ...
    <div class="txtTinyMce-wrapper" style="line-height: 1.2; font-size: 12px; font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif; color: #555555; mso-line-height-alt: 14px;">
    <p style="font-size: 16px; line-height: 1.2; font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Enq. type: ${enquiryType}</span></p>
    <p style="font-size: 16px; line-height: 1.2; font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Name: ${username}</span></p>
    <p style="font-size: 16px; line-height: 1.2; font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">From: ${email}</span></p>
    <p style="font-size: 16px; line-height: 1.2; font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Subject: ${subject}</span></p>
    </div>
    </div>
    ...
    <div class="txtTinyMce-wrapper" style="font-size: undefined; line-height: 1.2; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: NaNpx;">
    ...
    <p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;"><span style="font-size: 12px;">This is an auto generated message. Please reply to ${email} for further communication.</span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if (!mso)&(!IE)]><!-->
