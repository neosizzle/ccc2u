...
app.post('/sendEmail' ,(req,res)=>{
    ...
    var smtpConfig = {
        ...
        secure: true, // use SSL
        auth: {
            user: process.env.NODEMAILER_TRANS_EMAIL,
            pass: process.env.NODEMAILER_TRANS_PASS
        }
    };
    ...
    <p style="font-size: 16px; line-height: 1.2; font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Enq. type: ${req.body.enquiryType}</span></p>
    <p style="font-size: 16px; line-height: 1.2; font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Name: ${req.body.name}</span></p>
    <p style="font-size: 16px; line-height: 1.2; font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">From: ${req.body.email}</span></p>
    <p style="font-size: 16px; line-height: 1.2; font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Subject: ${req.body.subject}</span></p>
    </div>
    </div>
    ...
    <p style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">${req.body.message}</p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if (!mso)&(!IE)]><!-->
